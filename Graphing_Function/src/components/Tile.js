...
function Tile({ tile, deleteTile, dashboards, setDashboards, width, height }) {
  ...
  const updateTileFilters = (newFilters) => {
    ...
    // Find and update the tile in the dashboards
    const updatedDashboards = dashboards.map(dashboard => {
      if (dashboard.tiles.some(t => t.id === tile.id)) {
        return {
          ...dashboard,
          tiles: dashboard.tiles.map(t => 
            t.id === tile.id ? { ...t, filters: newFilters } : t
          )
        };
      }
      return dashboard;
    ...
    // Update dashboards state and localStorage
      ...
      >
        <Box sx={{
          ...
          <FormControl fullWidth>
            ...
            >
              <MenuItem value={tile.x_axis}>{headers[tile.x_axis]}</MenuItem>
            </Select>
          </FormControl>
